...
public class WebElementConfiguration {
    ...
    private void setupCustomElements(Object object, WebClient webClient) throws Exception {
        ElementLocatorFactory factoryRef = new DefaultElementLocatorFactory(webClient.webDriver);
        FieldDecorator fieldDecorator = new AnotherFieldDecorator(factoryRef);
    ...
    private void setupCustomElementsForClass(Object object, Class<?> clazz, FieldDecorator fieldDecorator, WebClient webClient) throws Exception {
        for (Field field : clazz.getDeclaredFields()) {
            if (CustomElement.class.isAssignableFrom(field.getType())) {
                Object webElementProxy = fieldDecorator.decorate(clazz.getClassLoader(), field);
                field.setAccessible(true);
                ...
                customElement.webElement = (WebElement) webElementProxy;
            }
        }
        if (clazz.getSuperclass() != null) {
