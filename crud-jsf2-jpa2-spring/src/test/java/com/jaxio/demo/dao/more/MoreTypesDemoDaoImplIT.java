...
import com.jaxio.demo.repository.more.MoreTypesDemoGenerator;
...
@Transactional
public class MoreTypesDemoDaoImplIT {
    @SuppressWarnings("unused")
    private static final Logger log = Logger.getLogger(MoreTypesDemoDaoImplIT.class);
