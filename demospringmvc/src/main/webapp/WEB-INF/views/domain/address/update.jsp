...
<body>
	...
	<a href="${pageContext.request.contextPath}/domain/address/show/${address.id}" class="ajaxy button button-show"><fmt:message key="crud.show.button" /></a>
	...
	<form:form action="${pageContext.request.contextPath}/domain/address/update/${address.id}" modelAttribute="address" method="POST">
