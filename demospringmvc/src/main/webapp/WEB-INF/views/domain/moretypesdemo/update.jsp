...
<body>
	...
	<a href="${pageContext.request.contextPath}/domain/moretypesdemo/show/${moreTypesDemo.id}" class="ajaxy button button-show"><fmt:message key="crud.show.button" /></a>
	...
	<form:form action="${pageContext.request.contextPath}/domain/moretypesdemo/update/${moreTypesDemo.id}" modelAttribute="moreTypesDemo" method="POST">
