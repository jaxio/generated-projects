...
public class DocumentController {
    ...
    public String list(@ModelAttribute DocumentSearchForm documentSearchForm, Model model) {
        Page<Document> page = documentRepository.findWithExample(documentSearchForm.getDocument(), documentSearchForm
                .getRanges(), documentSearchForm.getSp().toPageRequest());
