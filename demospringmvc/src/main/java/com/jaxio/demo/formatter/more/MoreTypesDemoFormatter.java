 ...
 */
package com.jaxio.demo.formatter.more;
...
import com.jaxio.demo.domain.more.MoreTypesDemo_;
...
public class MoreTypesDemoFormatter implements DiscoverableFormatter<MoreTypesDemo> {
    ...
    public String print(MoreTypesDemo moreTypesDemo, Locale locale) {
        return FormatterUtil.print(MoreTypesDemo_.numberInt.getName() + "+'/'+" + MoreTypesDemo_.numberLong.getName()
                + "+'/'+" + MoreTypesDemo_.numberDouble.getName(), moreTypesDemo, locale);
    }
