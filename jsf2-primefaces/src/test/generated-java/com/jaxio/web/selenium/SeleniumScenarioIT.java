...
import com.jaxio.web.selenium.page.document.DocumentTabPage;
import com.jaxio.web.selenium.page.role.RoleSearchPage;
import com.jaxio.web.selenium.page.role.RoleTabPage;
...
public class SeleniumScenarioIT {
    ...
    private void loginAsAnAdmin(Client client) {
        ...
        assertThat(accountSearchPage.searchResultsRegion.getText()).contains("53");
    }
    ...
    private void searchForAccounts(Client client) {
        ...
        assertThat(accountSearchPage.searchResultsRegion.getText()).contains("13");
